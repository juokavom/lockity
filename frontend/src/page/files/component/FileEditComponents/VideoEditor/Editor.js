...
// Šis failas yra pasitelktas iš interneto ir neįeina į bakalaurinio darbo sudėtį
// Šaltinis: https://github.com/Prakshal-Jain/Reactive
class VideoEditor extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.playVideo.current.addEventListener('timeupdate', function () {
            ...
            self.progressBar.current.style.height = '100%'
    ...
    reset = () => {
        ...
        this.setState({timings: [{'start': 0, 'end': this.playVideo.current.duration}]}, () => {
    ...
    captureSnapshot = () => {
        ...
        a.download = "snapshot-" + this.props.fileMetadata.title + ".png"; //File name Here
    ...
    render = () => {
        return(
            <div className="wrapper">
                ...
                <div className="controls row align-items-center d-flex justify-content-around">
                    <div className="player-controls col-auto p-1">
